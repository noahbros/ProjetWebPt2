...
routeCategories.post('/', verifierToken, isAdmin, isBibliothecaire, categoriesRegles, AddCategory)
routeCategories.delete('/',verifierToken, isAdmin, isBibliothecaire, query('id').notEmpty(), DeleteCategory)
routeCategories.put('/', verifierToken, isAdmin, isBibliothecaire, query('id').notEmpty(), categoriesRegles, UpdateCategory)
