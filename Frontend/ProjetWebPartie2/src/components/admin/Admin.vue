  ...
  <body class="admin-account-page">
    <nav class="navbar border-bottom border-body" style="background: #1e293b ">
      <div class="container-fluid">
        <a class="navbar-brand" style="color: #ffffff; font-weight: bold">Admin Profile</a>
      </div>
    </nav>
    ...
    <section style="background-color: #eee;">
      ...
      <div class="logout-section">
        ...
        <button @click="accessAdminCommands" class="btn btn-outline-success" type="submit" id="admin">Admin Controls</button>
        </div>
      </div>
    </section>
  </body>
