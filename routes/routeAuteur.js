...
routeAuteur.post("/", verifierToken, isAdmin, auteurRegles, AddAuteur)
...
routeAuteur.put("/:id", verifierToken, isAdmin, auteurRegles, modifierAuteur)
routeAuteur.delete("/:id", verifierToken, isAdmin, supprimerAuteur)
